...
from .convolutional_block import build_DwConv_Block
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=7, shift_size=0,
        ...
        self.dwconv_block = build_DwConv_Block(in_planes=dim, out_planes=dim)
...
_cfg = {
    ...
    'swin_tiny_patch4_window8_224': dict(
        params=dict(pretrain_img_size=224, patch_size=4, window_size=8, embed_dim=96, depths=(2, 2, 6, 2),
                    num_heads=(3, 6, 12, 24))
    ),
}
