...
import ltr.models.tracking.swin_transt_qkvcnn_enhance_encoderfusion_dwconv as swintranst_models
...
def run(settings):
    ...
    settings.env.workspace_dir = '/home/xlsun/xlsun/code/TransT-M/results/SwinTransT_Cvt_enhance_lr1e-4'
    ...
    dataset_train = sampler.TransTMaskSampler([got10k_train], [1],
                                            num_search_frames=1, num_template_frames=2,
                                            samples_per_epoch=600*settings.batch_size, max_gap=100, processing=data_processing_train,
                                            frame_sample_mode='transt')
    ...
    trainer.train(500, transt_path=settings.transt_path, load_latest=False, fail_safe=False)
